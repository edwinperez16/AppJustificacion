...
import 'package:just_app/src/models/response_helper.dart';
import 'package:just_app/src/models/user_model.dart';
import 'package:just_app/src/provider/db_provider.dart';


class CuentasService extends ChangeNotifier {
  final String urlBase = 'http://192.168.1.78/justificaciones-backend/public';
