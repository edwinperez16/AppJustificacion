...
import 'package:just_app/src/models/justificacion_model.dart';
...
class _JustificacionFormPageState extends State<JustificacionesFormPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Color(0xFFAD0837),
  ...
  return ElevatedButton(
    style: ButtonStyle(
      backgroundColor: MaterialStateProperty.all<Color>(Color(0xFFAD0837)),
    ),
    onPressed: () async {
